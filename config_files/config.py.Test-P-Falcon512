...
SERVER_CONFIG_FILE = "/root/experiment/sshd_config/sshd_config_p_falcon512"
...
CLIENT_SSH_KEY = "/root/experiment/client_keys/id_falcon512_key"

REMOTE_COMMAND = f"touch {SIGNAL_FILE}"
KEY_TYPE = "ssh-falcon512"
