...
SERVER_CONFIG_FILE = "/root/experiment/sshd_config/sshd_config_p_sphincssha2128fsimple"
...
CLIENT_SSH_KEY = "/root/experiment/client_keys/id_sphincssha2128fsimple_key"

REMOTE_COMMAND = f"touch {SIGNAL_FILE}"
KEY_TYPE = "ssh-sphincssha2128fsimple"
KEY_ALGORITHMS = f"HostKeyAlgorithms={KEY_TYPE}"
PUBKEY_ALGORITHMS = f"PubkeyAcceptedAlgorithms={KEY_TYPE}"
ALGORITHMS = "mlkem1024-sha384"
