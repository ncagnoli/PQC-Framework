...
# --- Server Settings ---
SERVER_BINARY = "/usr/sbin/sshd-pqc"
SERVER_CONFIG_FILE = "/root/experiment/sshd_config/sshd_config_h_rsa3072_sphincssha2128fsimple"
SERVER_ARGS = ["-D", "-e", "-p", "2222", "-f", SERVER_CONFIG_FILE]
PORT_TO_CHECK = 2222

# --- Client Settings ---
CLIENT_BINARY = "/usr/bin/ssh-pqc"
CLIENT_SSH_USER = "testuser"
CLIENT_SSH_HOST = "10.10.10.242"
CLIENT_SSH_PORT = PORT_TO_CHECK
CLIENT_SSH_KEY = "/root/experiment/client_keys/id_rsa3072_sphincssha2128fsimple_key"

REMOTE_COMMAND = f"touch {SIGNAL_FILE}"
KEY_TYPE = "ssh-rsa3072-sphincssha2128fsimple"
...
TEST_NAME = "Test-H-RsaSphics-3072+2128"
