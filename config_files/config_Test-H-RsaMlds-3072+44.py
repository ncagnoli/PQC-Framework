...
SERVER_CONFIG_FILE = "/root/experiment/sshd_config/sshd_config_h_rsa3072_mldsa44"
...
CLIENT_SSH_KEY = "/root/experiment/client_keys/id_rsa3072_mldsa44_key"

REMOTE_COMMAND = f"touch {SIGNAL_FILE}"
KEY_TYPE = "ssh-rsa3072-mldsa44"
...
TEST_NAME = "Test-H-RsaMlds-3072+44"
