...
SERVER_CONFIG_FILE = "/root/experiment/sshd_config/sshd_config_p_mldsa44"
...
CLIENT_SSH_KEY = "/root/experiment/client_keys/id_mldsa44_key"

REMOTE_COMMAND = f"touch {SIGNAL_FILE}"
KEY_TYPE = "ssh-mldsa44"
